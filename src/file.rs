        ...
        let meshes = obj_models
            ...
            .map(|m| {
                ...
                for c in indices.chunks(3) {
                    ...
                    let pos0: glam::Vec3<_> = v0.position.into();
                    let pos1: glam::Vec3<_> = v1.position.into();
                    let pos2: glam::Vec3<_> = v2.position.into();

                    let uv0: glam::Vector2<_> = v0.tex_coords.into();
                    let uv1: glam::Vector2<_> = v1.tex_coords.into();
                    let uv2: glam::Vector2<_> = v2.tex_coords.into();
